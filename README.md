...
We also have detailed energy benchmark results (which measures energy differences pre and post optimization with ground truth and optimizes structures using the semi-empirical method GNF2-XTB) in the associated folder, along with a detailed description of the motivation and methodology. 
