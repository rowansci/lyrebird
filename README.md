...
This repository contains the **Lyrebird** neural network model for 3D conformer generation, developed by Rowan based on the [ETFlow Architecure](https://arxiv.org/abs/2410.22388v1). You can use the pretrained model weights locally or run predictions directly via the [Rowan web platform](https://labs.rowansci.com/).
